...
def main():
    ...
    for task in tasks:        
        for probe in ['recommendation', 'search']:
            ...
            # for model in ['kamalkraj/deberta-v2-xlarge']:                
            # for model in ['bert-base-cased', 'kamalkraj/deberta-v2-xlarge']:                
    ...
    if write_R_with_X_cand_file:
        ...
        random_line = ["search", "random", "kamalkraj/deberta-v2-xlarge"]
    ...
    if calculate_corrs:
        ...
        year_agg = dfs_raw[dfs_raw["model"] == "kamalkraj/deberta-v2-xlarge"].\
        ...
        dfs_raw_corr = dfs_raw[dfs_raw["model"] == 'kamalkraj/deberta-v2-xlarge']
        ...
        tokenizer = BertTokenizer.\
                from_pretrained('kamalkraj/deberta-v2-xlarge')
    ...
    #                     (df_lists["task"]==task) & 
    #                     (df_lists["model"]=="kamalkraj/deberta-v2-xlarge")][metric].values[0]
